...
var validateGetUserInput_1 = require("./../validation/validateGetUserInput");
exports.getUserResolver = {
    getUser: function (_, args) {
        var _this = this;
        var _a = validateGetUserInput_1.validateGetUserInput(args), errors = _a.errors, isValid = _a.isValid;
        if (!isValid) {
            return { status: { code: 400 }, node: { errors: errors } };
        }
        var email = args.email, name = args.name;
        return selectors_1.findUser(__assign({}, args))
            ...
            return __generator(this, function (_a) {
                ...
                else if (!(existingUser === null || existingUser === void 0 ? void 0 : existingUser.email) && name) {
                    return [2 /*return*/, {
                            status: { code: 400 },
                            node: {
                                errors: {
